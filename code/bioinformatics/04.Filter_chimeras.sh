...
## reference-based chimera filtering in VSEARCH. I choose to use VSEARCH over
## DADA2 for chimera filtering for two reasons:
...
readonly MAP_SCRIPT="$PROJECT_PATH/data/map.pl"                                   ## Map file for fasta reconstruction
readonly REFERENCE_SEQS="$PROJECT_PATH/data/06.Reference_dataset/ITS2/ITS2.fasta" ## Path to UNITE reference dataset
readonly DENOISED_DIR="$PROJECT_PATH/data/05.Denoised"                            ## Path to denoised fasta file
readonly CHIMERA_FILTERED_DIR="$PROJECT_PATH/data/07.Chimera_filtered"            ## Path for chimera filtered fasta file
...
TRACK_REPSEQS_READS_FILE="$PROJECT_PATH/data/07.Chimera_filtered/summary_chimeraFiltered.txt"
